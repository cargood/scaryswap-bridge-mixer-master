...
export declare class Trade {
    ...
    constructor(route: Route, tradeType: TradeType, inputAmount: CurrencyAmount, outputAmount: CurrencyAmount, executionPrice: Price, nextMidPrice: Price, priceImpact: Percent);
    /**
