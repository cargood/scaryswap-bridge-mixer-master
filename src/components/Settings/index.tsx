...
export default function SettingsTab() {
  ...
  const onInputChange = (event: { target: { value: string } }) => {
    const valueAsIntFromRoundedFloat = Number.parseInt((Number.parseFloat(event.target.value) * 100).toString())
                ...
                <div className="relative p-4 bg-white dark:bg-zinc-800">
                  <div className="inline-flex items-center">
                    ...
                    <div className="ml-2">
                      ...
                      >
                        <StyledIcon as="InformationCircleIcon" size={5} className="block text-gray-400" />
                      </Tooltip>
                    </div>
                  </div>
