...
function i(e, t) {
  var i = e.reduce(function(e, t) {
      return (
        e[t.chainId] || (e[t.chainId] = {}), (e[t.chainId][t.address] = t), e
      );
    }, {}),
    n = t.reduce(
      function(e, t) {
        ...
        if (o) {
          ...
          s.length > 0 &&
            (e.changed[t.chainId] || (e.changed[t.chainId] = {}),
            (e.changed[t.chainId][t.address] = s));
        } else e.added.push(t);
        return (
          e.index[t.chainId]
            ? (e.index[t.chainId][t.address] = !0)
            : (e.index[t.chainId] = (((r = {})[t.address] = !0), r)),
          e
        );
      },
      { added: [], changed: {}, index: {} }
    ...
    r = e.reduce(function(e, t) {
      return (
        (n.index[t.chainId] && n.index[t.chainId][t.address]) || e.push(t), e
      );
    }, []);
  return { added: n.added, changed: n.changed, removed: r };
}
Object.defineProperty(exports, '__esModule', { value: !0 }),
  ((e = exports.VersionUpgrade || (exports.VersionUpgrade = {}))[(e.NONE = 0)] =
    'NONE'),
  (e[(e.PATCH = 1)] = 'PATCH'),
  (e[(e.MINOR = 2)] = 'MINOR'),
  (e[(e.MAJOR = 3)] = 'MAJOR'),
  (exports.diffTokenLists = i),
  (exports.getVersionUpgrade = function(e, t) {
    return t.major > e.major
      ? exports.VersionUpgrade.MAJOR
      : t.major < e.major
      ? exports.VersionUpgrade.NONE
      : t.minor > e.minor
      ? exports.VersionUpgrade.MINOR
      : t.minor < e.minor
      ? exports.VersionUpgrade.NONE
      : t.patch > e.patch
  ...
  (exports.minVersionBump = function(e, t) {
    var n = i(e, t);
    return n.removed.length > 0
      ? exports.VersionUpgrade.MAJOR
      : n.added.length > 0
      ? exports.VersionUpgrade.MINOR
      : Object.keys(n.changed).length > 0
      ? exports.VersionUpgrade.PATCH
      : exports.VersionUpgrade.NONE;
  }),
  ...
  (exports.schema = {
    ...
    definitions: {
      ...
      ExtensionValue: {
        anyOf: [
          { type: 'string', minLength: 1, maxLength: 30, examples: ['#00000'] },
          { type: 'boolean', examples: [!0] },
      ...
      TokenInfo: {
        ...
        properties: {
          ...
          extensions: {
            ...
            maxProperties: 10,
            examples: [{ color: '#000000', is_verified_by_me: !0 }],
          },
        },
