...
const ZERO_BASE_FEE = new Percent(JSBI.BigInt(0), JSBI.BigInt(10000))
const ONE_HUNDRED_PERCENT = new Percent(JSBI.BigInt(10000), JSBI.BigInt(10000))
const INPUT_FRACTION_AFTER_FEE = ONE_HUNDRED_PERCENT.subtract(BASE_FEE)
const INPUT_FRACTION_AFTER_ZERO_FEE = ONE_HUNDRED_PERCENT.subtract(ZERO_BASE_FEE)
    ...
    : ONE_HUNDRED_PERCENT.subtract(
        trade.route.pairs.reduce<Fraction>(
          (currentFee: Fraction): Fraction =>
            currentFee.multiply(isZeroFee ? INPUT_FRACTION_AFTER_ZERO_FEE : INPUT_FRACTION_AFTER_FEE),
          ONE_HUNDRED_PERCENT
        )
      )
