...
export function useToken(tokenAddress?: string): Token | undefined | null {
  ...
  const tokenNameBytes32 = useSingleCallResult(token ? undefined : tokenContractBytes32, 'name', undefined)
  const symbol = useSingleCallResult(token ? undefined : tokenContract, 'symbol', undefined)
  const symbolBytes32 = useSingleCallResult(token ? undefined : tokenContractBytes32, 'symbol', undefined)
  const decimals = useSingleCallResult(token ? undefined : tokenContract, 'decimals', undefined)
