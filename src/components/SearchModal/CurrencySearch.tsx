  ...
  return (
    <ContentWrapper>
      <PaddedColumn gap="16px">
        <RowBetween>
          <p className="text-gray-500 dark:text-white">Select a token</p>
          <CloseIcon onClick={onDismiss} className="text-gray-500 dark:text-white" />
        </RowBetween>
        <Row>
          <input
            type="text"
            id="token-search-input"
            className="relative flex p-4 items-center w-full whitespace-nowrap bg-transparent border border-solid border-gray-300 focus:border-indigo-600 focus:outline-none focus:ring-0 rounded-lg text-gray-800 dark:text-zinc-50"
          ...
          <ButtonText onClick={showManageView} color={theme.blue1} className="list-token-manage-button">
            <RowFixed>
              <IconWrapper size="16px" marginRight="6px">
                <Edit className="stroke-gray-500 dark:stroke-white" />
              </IconWrapper>
              <p className="text-gray-500 dark:text-white">Manage</p>
            </RowFixed>
          </ButtonText>
        </Row>
      </Footer>
