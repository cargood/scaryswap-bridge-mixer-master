  ...
  async function onWithdraw() {
    if (stakingContract && stakingInfo?.stakedAmount) {
      ...
      await stakingContract
        .Unstake(ethers.utils.parseUnits(stakingInfo.stakedAmount.toFixed(18)), { gasLimit: "300000" })
      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          ...
          <TYPE.subHeader style={{ textAlign: 'center' }}>
            When you withdraw, your PUMPKIN is claimed and your liquidity is removed from the mining pool.
          </TYPE.subHeader>
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOndismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            <TYPE.body textAlign={"center"} fontSize={20}>Withdrawing {stakingInfo?.stakedAmount?.toSignificant(4)} {stakingInfo?.stakedAmount.token.name}</TYPE.body>
